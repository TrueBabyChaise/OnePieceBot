...
import { ListInventoryCommand } from "../../list.interaction";
...
export class HelpNextPageButtonInteraction extends BaseInteraction {
	constructor() {
		super("invnextpage", "Go to the next page of the shop menu");
	}
	...
	async execute(client: BaseClient, interaction: ButtonInteraction): Promise<void> {
		...
		if (pageIndex) {
			...
			await interaction.editReply(await ListInventoryCommand.optionsListCommandEmbed(client, newPageIndex, interaction.user.id));
		} else {
